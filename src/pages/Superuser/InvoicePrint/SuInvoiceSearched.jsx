...
import SuInvoicePrint from './SuInvoicePrint';
import { borderRadius } from '@mui/system';


function SuInvoiceSearch() {
    ...
    const editInvoice = (InvNumber) => {
        ...
        history.push('/su/editInvoice/' + InvNumber)
    }
        ...
        <div className='saInvoiceSearchBody'>
            ...
            <div className='saInvoiceSearchBody__container'>
                ...
                <div className='saInvoiceSearch__right'>
                    <SuInvoicePrint propsData={propsData} />
                </div>
            </div>
        </div>
    )
...
export default SuInvoiceSearch