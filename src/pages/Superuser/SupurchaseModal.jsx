...
import SuTrackerUpdate from './SuTrackerUpdate';
...
function SupurchaseModal(props) {
                                    ...
                                    <div className='sapurchaseModal__body__tracker'>
                                        <div className='sapurchaseModal__body__card'>
                                            <div className='sapurchaseModal__body__card__left'>
                                                {/* <img src={item?.cardetails?.url} alt='img' /> */}
                                                <motion.img
...
export default SupurchaseModal